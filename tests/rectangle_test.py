...
class TestRectangeFunctions(unittest.TestCase):
    ...
    def test_area_large_number(self):
       self.assertEqual(area(999999999999999, 999999999999999), 999999999999999 ** 2)

    def test_area_small_number(self):
       self.assertEqual(area(1e-7, 1e-7), 1e-7 * 1e-7)
    ...
    def test_perimeter_large_number(self):
       self.assertEqual(perimeter(999999999999999, 999999999999999), 2*999999999999999 * 2)

    def test_perimeter_small_number(self):
       self.assertEqual(perimeter(1e-7, 1e-7), 2 * 1e-7 * 2)
